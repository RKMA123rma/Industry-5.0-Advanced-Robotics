...
1. [Input Preprocessing Unit](#1-input-preprocessing-unit)
   ...
   - [1.7Color Sensor Controller](#17-color-sensor-controller)
   - [1.8ADC Controller](#18-adc-controller)
2. [Processing Unit](#2-processing-unit)
   - [2.1 RISC-V CPU Core (RV32I)](#21-risc-v-cpu-core-rv32i)
   - [2.2 Shortest Path Loader (BFS)](#22-shortest-path-loader-bfs)
   - [2.3 Reset Module](#23-reset-module)
3. [Post-Processing Unit](#3-post-processing-unit)
   - [3.1 CPU-Path & Turns Arbitrator](#31-cpu-path--turns-arbitrator)
   - [3.2 Turn & Node Controller](#32-turn--node-controller)
   - [3.3 Industry Turns Graph](#33-industry-turns-graph)
   - [3.4 LFA Controller](#34-lfa-controller)
   - [3.5 PWM Generators & Motor Drivers](#35-pwm-generators--motor-drivers)
4. [Object Handling & Communication Unit](#4-object-handling--communication-unit)
   - [4.1 Object Handling](#41-object-handling)
   - [4.2 Obstacle Handling](#42-obstacle-handling)
   - [4.3 Communication Handling & UART Transmission](#43-communication-handling--uart-transmission)
   - [4.4 TX Controller for Message Sequencing](#44-tx-controller-for-message-sequencing)
   - [4.5 Clock Domain Crossing (CDC) Handler](#45-clock-domain-crossing-cdc-handler)
...
![Object-Obstacle Handling](Industry-5.0-Advanced-Robotics/hardware and module descriptions/obstflow.png)
