...
2. [Color Sensor Controller](#2-color-sensor-controller)
3. [ADC Controller](#3-adc-controller)
4. [Processing Unit](#4-processing-unit)
...
5. [Post-Processing Unit](#5-post-processing-unit)
...
6. [Object Handling & Communication Unit](#6-object-handling--communication-unit)
