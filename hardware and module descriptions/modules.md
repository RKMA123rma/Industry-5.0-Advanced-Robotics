...
2. [Processing Unit](#2-processing-unit)
   - [2.1 RISC-V CPU Core (RV32I)](#41-risc-v-cpu-core-rv32i)
   - [2.2 Shortest Path Loader (BFS)](#42-shortest-path-loader-bfs)
   - [2.3 Reset Module](#43-reset-module)
3. [Post-Processing Unit](#5-post-processing-unit)
   - [3.1 CPU-Path & Turns Arbitrator](#51-cpu-path--turns-arbitrator)
   - [3.2 Turn & Node Controller](#52-turn--node-controller)
   - [3.3 Industry Turns Graph](#53-industry-turns-graph)
   - [3.4 LFA Controller](#54-lfa-controller)
   - [3.5 PWM Generators & Motor Drivers](#55-pwm-generators--motor-drivers)
4. [Object Handling & Communication Unit](#6-object-handling--communication-unit)
   - [4.1 Object Handling](#61-object-handling)
   - [4.2 Obstacle Handling](#62-obstacle-handling)
   - [4.3 Communication Handling & UART Transmission](#63-communication-handling--uart-transmission)
   - [4.4 TX Controller for Message Sequencing](#64-tx-controller-for-message-sequencing)
   - [4.5 Clock Domain Crossing (CDC) Handler](#65-clock-domain-crossing-cdc-handler)
